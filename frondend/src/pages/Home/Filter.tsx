...
import { cityOpt, sortOpt } from "../../Contants"
...
<div className="flex flex-col gap-2">
  <label onChange={(e)=>handleChange("location",e.target.value)}
   className="font-bold">Konaklama yeri adına göre ara</label>
<input placeholder="örn:SeaSide Villa" type="text" className="border py-1 px-4 rounded-md"/>
</div>
<div className="flex flex-col gap-2">
...
<div className="flex justify-end">
  ...
  type="reset"
  className="bg-blue-500 p-1 px-4 text-white rounded-md w-fit">Filtreleri Temizle</button>
</div>
   </form>
  )
}
